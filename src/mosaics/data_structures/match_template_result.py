...
class MatchTemplateResult:
    ...
    maximum_intensity_projection_path: Optional[str] = None
    cross_correlation_average_path: Optional[str] = None
    cross_correlation_variance_path: Optional[str] = None
    scaled_mip_path: Optional[str] = None
    best_phi_path: Optional[str] = None
    best_theta_path: Optional[str] = None
    best_psi_path: Optional[str] = None
    best_defocus_path: Optional[str] = None
    ...
    def __init__(
        ...
        self.maximum_intensity_projection_path = (
    ...
    #     """Convert the MatchTemplateResult object to a JSON-serializable
    #     dictionary.
    #     """
    #     return {
    ...
    #             self.maximum_intensity_projection_path,
    #         ),
    #         "cross_correlation_average_path": (
    #             self.cross_correlation_average_path,
    #         ),
    #         "cross_correlation_variance_path": (
    #             self.cross_correlation_variance_path,
    #         ),
    ...
    #             "maximum_intensity_projection_path"
    #         ],
    #         cross_correlation_average_path=json_dict[
    #             "cross_correlation_average_path"
    #         ],
